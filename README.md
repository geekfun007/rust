...
1. **[book-manager](./book-manager/)** 📚 - 图书管理系统（模块化示例）
2. **[shopping-cart](./shopping-cart/)** 🛒 - 购物车系统（业务逻辑分层）
3. **[rust-http-api-demo](./rust-http-api-demo/)** 🌐 - HTTP API 服务（三层架构）
4. **[rust-asyncio](./rust-asyncio/)** ⚡ - 异步框架实现（类 Python asyncio）
...
- **教程主题：** 20+ 个核心主题
- **代码示例：** 400+ 个完整示例 🆕
- **实战项目：** 4 个完整项目 🆕（HTTP API + asyncio + 图书管理 + 购物车）
